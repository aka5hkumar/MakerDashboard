This is my Makerspace dashboard application. It allows for the tracking of the Ultimaker and Stratasys printers in the NYU Makerspace.
This is just the front-end, with a json file feeding it. The backend was created my modifying the stratasys api found [here](https://github.com/nkaminski/stratasys_api)
-----------------------------------------------------------------------------------------------------------------------
